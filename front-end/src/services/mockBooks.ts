...
export const MOCK_BOOKS: MockBook[] = [
  ...
  },
  {
    ...
    pages: 264,
    genre: 'Fantasia',
    cover: 'https://books.google.com/books/content?id=i48xDQAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
    editora: 'Rocco',
    ano: 1997,
  ...
  },
  {
    ...
    pages: 288,
    genre: 'Fantasia',
    cover: 'https://books.google.com/books/content?id=bJg0DwAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
    editora: 'Rocco',
    ano: 1998,
  ...
  },
  {
    ...
    pages: 348,
    genre: 'Fantasia',
    cover: 'https://books.google.com/books/content?id=y_ZCDwAAQBAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
    editora: 'Rocco',
    ano: 1999,
