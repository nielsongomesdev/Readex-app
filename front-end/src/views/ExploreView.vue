  ...
  <div class="select-none font-poppins text-[#13213C] pb-6">
    ...
    <div class="hidden lg:block space-y-8">
      ...
      <div class="grid grid-cols-3 gap-8">
        ...
        <div class="col-span-2 space-y-4">
          ...
          <!-- Error Alert Desktop -->
          <div v-if="errorOccurred" class="bg-red-50 border border-red-200 text-red-700 px-5 py-4 rounded-2xl flex items-center gap-3 animate-fade-in">
    ...
    <div class="lg:hidden flex flex-col space-y-6">
      ...
      <div class="space-y-3">
        ...
        <!-- Error Alert Mobile -->
        <div v-if="errorOccurred" class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-center gap-2.5 animate-fade-in">
          <svg class="w-4 h-4 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
          <span class="text-[11px] font-semibold leading-snug">{{ errorMessage }}</span>
        </div>
